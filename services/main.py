    ...
    def supprimer_produit(self, reference):
        for product in self.products:
            if product.reference == reference:
                self.products.supprimer(product)
    ...
    while True:
        ...
        if main_choice == "1":
            ...
            if product_type_choice == "1":
                ...
                cart.ajouter_produit(Medicament(nom, prix, categorie, reference, date_Exp, utilisation))
                ...
                cart.ajouter_produit(Produit_Pack(nom, prix, categorie, reference, date_Exp, pack_quantity))
